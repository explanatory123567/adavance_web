...
export default function ProductCard({ product, isPrebuilt = false }) {
  const {
    userRole,
    addToCart,
    wishlist,
  ...
  return (
    <div
      className="cyber-card product-card inline-productcard-0"
    ...
    >
      ...
      <div className="inline-productcard-1">
        <img
          src={product.image}
          alt={product.name}
          className="product-img-hover inline-productcard-2"
        />

        {/* Top Badges */}
        <div className="inline-productcard-3">
          {product.badge && (
            <span className="badge badge-purple inline-productcard-4">
              {product.badge}
            </span>
          )}
          {product.performanceScore && (
            <span className="badge badge-cyan inline-productcard-5">
        ...
        <div className="inline-productcard-6">
          <button
            ...
            title={
              userRole === "guest" ? "Login to Wishlist" : "Add to Wishlist"
            }
          >
            <Heart
              size={15}
        ...
        <div className="inline-productcard-7">
          {product.stock <= 5 && product.stock > 0 ? (
            <span className="badge badge-amber inline-productcard-8">
              Only {product.stock} Left
            </span>
          ) : product.inStock ? (
            <span className="badge badge-green inline-productcard-9">
              In Stock
            </span>
          ) : (
            <span className="badge badge-red inline-productcard-10">
              Out of Stock
            </span>
          )}
        </div>
      ...
      <div className="inline-productcard-11">
        ...
        {/* Title */}
        <h4 className="inline-productcard-17">{product.name}</h4>

        {/* Spec snippet */}
        <div className="inline-productcard-18">
          {isPrebuilt ? (
            <div>{product.fps4k}</div>
          ) : product.specs ? (
            <div>
        ...
        <div className="flex-between inline-productcard-19">
          ...
          <div className="inline-productcard-22">
            ...
            <button
              ...
              className="btn btn-primary btn-sm inline-productcard-23"
              title={userRole === "guest" ? "Login to Purchase" : "Add to Cart"}
            >
