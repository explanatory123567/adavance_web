...
export default function MyBuildsPage() {
  ...
  const handleOpenInBuilder = (build) => {
    ...
    showToast(
      "Build Loaded",
      `"${build.name}" loaded into 3D PC Builder Studio.`,
      "success",
    );
  ...
  return (
    <div className="my-builds-page inline-mybuildspage-0">
      <div className="container-wide">
        ...
        <div className="flex-between inline-mybuildspage-1">
          <div>
            ...
            <p className="inline-mybuildspage-5">
              Manage your personal high-performance PC configurations, benchmark
              scores, and order quotes.
            </p>
          </div>
        ...
        {savedBuilds.length === 0 ? (
          <div className="cyber-card-static inline-mybuildspage-6">
            <Layers
              size={48}
              color="var(--text-muted)"
              className="inline-mybuildspage-7"
            />
            <h3 className="inline-mybuildspage-8">No Saved Builds Yet</h3>
            <p className="inline-mybuildspage-9">
              Launch the 3D PC Builder Studio to customize and save your dream
              gaming setup.
            </p>
            <button
              onClick={() => setCurrentPage("builder")}
          ...
          <div className="grid-cols-3">
            {savedBuilds.map((build) => (
              <div key={build.id} className="cyber-card inline-mybuildspage-10">
                {/* Build Image & Score */}
                <div className="inline-mybuildspage-11">
                  <img
                    ...
                    alt={build.name}
                    className="inline-mybuildspage-12"
                  />
                ...
                <div className="inline-mybuildspage-16">
                  ...
                  <div className="inline-mybuildspage-23">
                    <button
                      onClick={() => addCustomBuildToCart(build)}
                      className="btn btn-primary inline-mybuildspage-24"
                    >
                    ...
                    <div className="inline-mybuildspage-25">
                      <button
                        onClick={() => handleOpenInBuilder(build)}
