...
import { Wrench, ArrowRight, Sparkles, Flame, Clock, Cpu, Monitor, ChevronRight, TrendingUp, SlidersHorizontal } from 'lucide-react';
export default function HomePage() {
  ...
  const popularCpus = products.filter(p => p.category === 'cpu' && p.isPopular);
  const popularGpus = products.filter(p => p.category === 'gpu' && p.isPopular);
  const featuredComponents = products.filter(p => p.featured);
  return <div className="home-page inline-homepage-0">
      {/* ==================== HERO SECTION ==================== */}
          ...
          <div className="inline-homepage-4">
            ...
            <div className="inline-homepage-5">
              ...
              <p className="inline-homepage-10">
                Create a PC that fits your needs and budget. Choose your components, check compatibility, compare performance, and customize your build with confidence.
                 Shop pre-built gaming PCs or design your own in our interactive 3D builder. Pick every part, check compatibility instantly, and see your rig come to life before you buy.
              </p>

              {/* CTAs */}
              <div className="inline-homepage-11">
                <button onClick={() => setCurrentPage('builder')} className="btn btn-primary btn-lg inline-homepage-12">
                  <Wrench size={18} />
                  <span>Build Your Custom PC</span>
                  <ArrowRight size={16} />
                </button>

                <button onClick={() => setCurrentPage('components')} className="btn btn-secondary btn-lg">
              ...
              <div className="inline-homepage-13">
                <div>
                  <div className="inline-homepage-14">
                    Interactive
                  </div>
                  <div className="inline-homepage-15">3D PC Builder Tool</div>
                </div>
                <div>
                  <div className="inline-homepage-16">
                    24-Hour
                  </div>
                  <div className="inline-homepage-17">Stress-Test & Dispatch</div>
                </div>
                <div>
                  <div className="inline-homepage-18">
                    3-Year
                  </div>
                  <div className="inline-homepage-19">Full Warranty Coverage</div>
                </div>
              </div>
            </div>
              ...
              <div className="cyber-card-static inline-homepage-21">
                ...
                <div className="inline-homepage-26">
                  ...
                  <div className="inline-homepage-28">
                    <span className="inline-homepage-29">RTX 5090 32GB</span>
                  </div>

                  <div className="inline-homepage-30">
                    <span className="inline-homepage-31">Core Ultra 9 285K</span>
                  </div>
                </div>
                ...
                <div className="inline-homepage-32">
                  <div className="flex-between inline-homepage-33">
                    <h3 className="inline-homepage-34">Apex Phantom Ultra</h3>
                    <div className="inline-homepage-35">
                      ₱3,999
                    </div>
                  </div>
                  <div className="inline-homepage-36">
                    <span>64GB DDR5-6400</span> • <span>4TB Gen5 SSD</span> • <span>360mm LCD AIO</span>
                  </div>

                  <button onClick={() => setCurrentPage('builder')} className="btn btn-outline-cyan inline-homepage-37">
            ...
            <div className="inline-homepage-40">
              ...
              <div>
                <div className="inline-homepage-42">
                  <span className="badge badge-red inline-homepage-43">CYBER FLASH SALE</span>
                  <span className="inline-homepage-44">GET 10% OFF WITH CODE: CYBER2026</span>
                </div>
                <h3 className="inline-homepage-45">
                  Save Up to $400 on RTX 4080 Super & Ryzen 7 7800X3D Pre-Builts
                </h3>
              </div>
            </div>
            ...
            <div className="inline-homepage-46">
              ...
              <div className="inline-homepage-49">
                <div className="inline-homepage-50">
                  <div className="inline-homepage-51">{String(timeLeft.hours).padStart(2, '0')}</div>
                  <div className="inline-homepage-52">HRS</div>
                </div>
                <div className="inline-homepage-53">
                  <div className="inline-homepage-54">{String(timeLeft.minutes).padStart(2, '0')}</div>
                  <div className="inline-homepage-55">MIN</div>
                </div>
                <div className="inline-homepage-56">
                  <div className="inline-homepage-57">{String(timeLeft.seconds).padStart(2, '0')}</div>
                  <div className="inline-homepage-58">SEC</div>
                </div>
              </div>

              <button onClick={() => setCurrentPage('components')} className="btn btn-primary inline-homepage-59">
                Claim Deal
              </button>
            </div>
          </div>
      ...
      <section className="inline-homepage-60">
        <div className="container-wide">
          <div className="flex-between inline-homepage-61">
            ...
            <button onClick={() => setCurrentPage('components')} className="btn btn-secondary">
          ...
          <div className="grid-cols-4">
            {prebuilts.map(pc => <ProductCard key={pc.id} product={pc} isPrebuilt={true} />)}
          </div>
        </div>
      </section>
      ...
      <section className="inline-homepage-64">
        <div className="container-wide">
          <div className="inline-homepage-65">
            <span className="badge badge-purple inline-homepage-66">FLAGSHIP HARDWARE</span>
            <h2 className="inline-homepage-67">
              Popular CPUs & Powerhouse GPUs
            </h2>
            <p className="inline-homepage-68">
              Hand-selected silicon tested for peak overclocking headroom and low thermal resistance.
            </p>
          </div>
            ...
            <div className="cyber-card-static inline-homepage-70">
              <div className="flex-between inline-homepage-71">
                <div className="inline-homepage-72">
                  ...
                  <div>
                    <h3 className="inline-homepage-74">Top Gaming Processors (CPUs)</h3>
                    <div className="inline-homepage-75">AM5 & LGA1851 Flagships</div>
                  </div>
                </div>
                <button onClick={() => {
              ...
              <div className="inline-homepage-76">
                {popularCpus.map(cpu => <ProductCard key={cpu.id} product={cpu} />)}
              </div>
            </div>
            ...
            <div className="cyber-card-static inline-homepage-77">
              <div className="flex-between inline-homepage-78">
                <div className="inline-homepage-79">
                  ...
                  <div>
                    <h3 className="inline-homepage-81">Top Graphics Cards (GPUs)</h3>
                    <div className="inline-homepage-82">RTX 5090 / 4080 Super & RX 7900 XTX</div>
                  </div>
                </div>
                <button onClick={() => {
              ...
              <div className="inline-homepage-83">
                {popularGpus.map(gpu => <ProductCard key={gpu.id} product={gpu} />)}
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="inline-homepage-84">
        <div className="container-wide">
          <div className="flex-between inline-homepage-85">
            <div>
              <span className="badge badge-cyan inline-homepage-86">COMPONENT INVENTORY</span>
              <h2 className="inline-homepage-87">Featured Hardware & Components</h2>
            </div>

            {/* Tabs Switcher */}
            <div className="inline-homepage-88">
              <button onClick={() => setActiveTab('bestsellers')} style={{
              padding: '6px 14px',
              borderRadius: '6px',
              fontSize: '13px',
              fontWeight: 600,
              background: activeTab === 'bestsellers' ? 'rgba(0, 240, 255, 0.15)' : 'transparent',
              color: activeTab === 'bestsellers' ? 'var(--neon-cyan)' : 'var(--text-muted)'
            }}>
                Best Sellers
              </button>
              <button onClick={() => setActiveTab('newarrivals')} style={{
              padding: '6px 14px',
              borderRadius: '6px',
              fontSize: '13px',
              fontWeight: 600,
              background: activeTab === 'newarrivals' ? 'rgba(157, 78, 221, 0.18)' : 'transparent',
              color: activeTab === 'newarrivals' ? '#c084fc' : 'var(--text-muted)'
            }}>
                New Arrivals
              </button>
            </div>
          ...
          <div className="grid-cols-4">
            {featuredComponents.slice(0, 8).map(comp => <ProductCard key={comp.id} product={comp} />)}
          </div>
        </div>
      </section>
          ...
          <div className="inline-homepage-90">
            ...
            <div className="inline-homepage-92">
              ...
              <h2 className="inline-homepage-94">
                Visualize Your Dream Rig In <span className="text-gradient-cyan">Real-Time 3D</span>
              </h2>
              <p className="inline-homepage-95">
                Select matching CPU sockets, custom liquid cooling loops, high-wattage ATX 3.0 PSUs, and panoramic glass cases. Our interactive 3D viewport lets you rotate 360°, inspect internal components, and test RGB lighting presets in real-time.
              </p>

              <div className="inline-homepage-96">
                <button onClick={() => setCurrentPage('builder')} className="btn btn-primary btn-lg">
                  <Wrench size={18} /> Launch 3D PC Builder Studio
                </button>
                <button onClick={() => setCurrentPage('compare')} className="btn btn-secondary btn-lg">
