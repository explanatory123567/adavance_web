...
export default function CheckoutPage() {
  const { cart, placeOrder, setCurrentPage, authUser, addresses } = useApp();
  ...
  const [promoCode] = useState(() => localStorage.getItem("nextgear_promo") || "");
  ...
  useEffect(() => {
    ...
    setCustomerName(defaultAddress.recipient);
    setCustomerPhone(defaultAddress.phone);
  }, [addresses]);

  const selectAddress = (id) => {
    const selected = addresses.find((item) => item._id === id);
    ...
    setCustomerName(selected.recipient);
  ...
  const promoDiscount = promoCode === "CYBER2026" ? subtotal * 0.1 : 0;
  const tax = (subtotal - promoDiscount) * 0.075;
  ...
  const handlePlaceOrderSubmit = async (e) => {
    ...
    if (newOrder) {
      localStorage.removeItem("nextgear_promo");
  ...
  if (completedOrder) {
    return (
      <div className="checkout-page inline-checkoutpage-0">
        <div className="container inline-checkoutpage-1">
          <div className="cyber-card-static inline-checkoutpage-2">
            ...
            <span className="badge badge-green inline-checkoutpage-4">
            ...
            <p className="inline-checkoutpage-6">
              Your order{" "}
              <strong className="inline-checkoutpage-7">
                #{completedOrder.id}
              </strong>{" "}
              has been transmitted to our cleanroom assembly laboratory.
            </p>

            <div className="inline-checkoutpage-8">
              <div className="flex-between">
                <span className="inline-checkoutpage-9">Tracking Number:</span>
                <span className="inline-checkoutpage-10">
                  {completedOrder.trackingNumber}
                </span>
              </div>
              <div className="flex-between">
                <span className="inline-checkoutpage-11">
                  Estimated Delivery:
                </span>
                <span className="inline-checkoutpage-12">
                  2-3 Business Days (Air Freight)
                </span>
              </div>
              <div className="flex-between">
            ...
            <div className="inline-checkoutpage-15">
              <button
                ...
                className="btn btn-primary inline-checkoutpage-16"
              >
                <Package size={16} /> View in Order History
              </button>
              <button
                onClick={() => setCurrentPage("home")}
                className="btn btn-secondary inline-checkoutpage-17"
              >
                Return to Home
              </button>
            </div>
  ...
  return (
    <div className="checkout-page inline-checkoutpage-18">
      <div className="container-wide">
        {/* Header */}
        <div className="inline-checkoutpage-19">
          <button
            onClick={() => setCurrentPage("cart")}
            className="inline-checkoutpage-20"
          >
          ...
          <p className="inline-checkoutpage-22">
            Complete your shipping address and payment method to begin cleanroom
            assembly.
          </p>
        </div>
            ...
            <div className="inline-checkoutpage-24">
              ...
              <div className="cyber-card-static inline-checkoutpage-25">
                <div className="inline-checkoutpage-26">
                  <div className="inline-checkoutpage-27">1</div>
                  <h3 className="inline-checkoutpage-28">
                ...
                <div className="form-group inline-checkoutpage-32">
                  <label className="form-label">
                    Phone Number (For Carrier Delivery PIN)
                  </label>
                  <input
                    type="tel"
                    className="form-control"
              ...
              <div className="cyber-card-static inline-checkoutpage-33">
                <div className="inline-checkoutpage-34">
                  <div className="inline-checkoutpage-35">2</div>
                  <h3 className="inline-checkoutpage-36">Shipping Address</h3>
                </div>

                <div className="form-group">
                  <label className="form-label">Choose from Address Book</label>
                  <select
                    className="form-control"
                  ...
                  {addresses.length === 0 && (
                    <button
                      type="button"
                      className="checkout-address-link"
                ...
                <div className="form-group">
                  ...
                  <div className="inline-checkoutpage-41">
                    ...
                    >
                      <div className="inline-checkoutpage-42">
                        ⚡ Insured Air Freight (Free)
                      </div>
                      <div className="inline-checkoutpage-43">
                    ...
                    >
                      <div className="inline-checkoutpage-44">
                        📦 Secured Ground Crate (₱25)
                      </div>
                      <div className="inline-checkoutpage-45">
              ...
              <div className="cyber-card-static inline-checkoutpage-46">
                <div className="inline-checkoutpage-47">
                  <div className="inline-checkoutpage-48">3</div>
                ...
                {paymentMethod === "GCash" ? (
                  <div className="inline-checkoutpage-52">
                    <div className="gcash-payment-panel">
                      <strong>Pay via GCash</strong>
                      <span>
                        Send the exact total to GCash account:{" "}
                        <b>
                          {process.env.REACT_APP_GCASH_NUMBER ||
                            "Set REACT_APP_GCASH_NUMBER"}
                        </b>
                      </span>
                      <small>
                  ...
                  <div className="inline-checkoutpage-56">
                    Pay when your order arrives. Please prepare the exact amount
                    for the courier.
                  </div>
                )}
              </div>
            ...
            <div className="cyber-card-static inline-checkoutpage-57">
              ...
              <div className="inline-checkoutpage-59">
                {cart.map((item) => (
                  <div
                    key={item.id}
                    className="flex-between inline-checkoutpage-60"
                  >
              ...
              <button
                type="submit"
                className="btn btn-primary inline-checkoutpage-69"
              >
                <Lock size={16} /> Place Order Now
              </button>

              <div className="inline-checkoutpage-70">
                Secure checkout with confirmation and order tracking.
              </div>
            </div>
          </div>
        </form>
