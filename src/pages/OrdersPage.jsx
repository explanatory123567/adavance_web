...
export default function OrdersPage() {
  ...
  return (
    <div className="orders-page inline-orderspage-0">
      <div className="container-wide">
        ...
        <div className="flex-between inline-orderspage-1">
          <div>
            ...
            <p className="inline-orderspage-5">
              Real-time laboratory assembly progress, carrier dispatch tracking,
        ...
        {filteredOrders.length === 0 ? (
          <div className="cyber-card-static inline-orderspage-7">
            <Package
              size={48}
              color="var(--text-muted)"
              className="inline-orderspage-8"
            />
          ...
          <div className="inline-orderspage-11">
            {filteredOrders.map((order) => {
              const isExpanded = expandedOrderId === order.id;
              return (
                <div
                  key={order.id}
                  className="cyber-card-static inline-orderspage-12"
                >
                  {/* Order Top Bar */}
                  <div
                    onClick={() => toggleExpand(order.id)}
                    className="inline-orderspage-13"
                  >
                    <div className="inline-orderspage-14">
                      <div>
                        <div className="inline-orderspage-15">Order ID</div>
                        <div className="inline-orderspage-16">#{order.id}</div>
                      </div>

                      <div>
                        <div className="inline-orderspage-17">Date Placed</div>
                        <div className="inline-orderspage-18">{order.date}</div>
                      </div>
                    ...
                    <div className="inline-orderspage-21">
                      ...
                      <button
                        onClick={(e) => {
                          ...
                          showToast(
                            "Invoice Downloaded",
                            `PDF for Order #${order.id} generated.`,
                            "success",
                          );
                        }}
                  ...
                  {isExpanded && (
                    <div className="inline-orderspage-23">
                      {/* Tracking Progress Timeline */}
                      {order.status !== "Cancelled" && (
                        <div className="inline-orderspage-24">
                          <div className="inline-orderspage-25">
                            Telemetry Tracking (
                            {order.trackingNumber || "Carrier Assigned"})
                          </div>
                          ...
                          <div className="inline-orderspage-26">
                            ...
                            {[
                              ...
                              <div key={idx} className="inline-orderspage-28">
                                <div
                                  style={{
                                    width: "28px",
                                    height: "28px",
                      ...
                      <div>
                        ...
                        <div className="inline-orderspage-30">
                          {order.items?.map((item, idx) => (
                            <div key={idx} className="inline-orderspage-31">
                              <div className="inline-orderspage-32">
                                {item.image && (
                                  <img
                                    src={item.image}
                                    alt={item.name}
                                    className="inline-orderspage-33"
                                  />
                                )}
                                <div>
                                  <div className="inline-orderspage-34">
                                    {item.name}
                                  </div>
                                  <div className="inline-orderspage-35">
                                    Qty: {item.quantity}
                                  </div>
                                </div>
                              </div>
